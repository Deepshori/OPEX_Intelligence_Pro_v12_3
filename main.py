...
APP_NAME = "OPEX Intelligence Pro v12.3"
...
class OpexIntelligenceApp(tk.Tk):
    ...
    def create_ui(self):
        pad = {"padx": 10, "pady": 7}
        title = tk.Label(self, text="OPEX Intelligence Pro v12.3", font=("Segoe UI", 18, "bold"), fg="#1F4E78")
        ...
        rules = (
            "v12.3 Professional Reporting: Category A excluded. Variance includes Bill/Bill Credit plus E-code journal expenses as per rules. "
